...
class Map
	...
	def initialize()
		...
		@cavern_0_0=Cavern.new(false,1,false,false,false,false,false)
		@cavern_0_1=Cavern.new(true,2,false,false,false,true,false)  
		...
		@cavern_1_2=Cavern.new(true,11,true,true,false,true,false)	
		@cavern_1_3=Cavern.new(false,12,false,false,false,false,false)
		@cavern_1_4=Cavern.new(false,13,false,false,false,false,false)
		@cavern_1_5=Cavern.new(true,14,false,true,true,true,false)	
		@cavern_1_6=Cavern.new(true,15,true,true,false,true,false)	
		@cavern_1_7=Cavern.new(true,16,false,true,false,true,false)	

		@cavern_2_0=Cavern.new(true,17,false,false,true,false,true) 	
		@cavern_2_1=Cavern.new(true,18,true,true,true,false,false) 
		@cavern_2_2=Cavern.new(true,19,true,true,true,false,false)	
		@cavern_2_3=Cavern.new(true,20,true,false,false,true,false) 
		@cavern_2_4=Cavern.new(false,21,false,false,false,false,false)
		@cavern_2_5=Cavern.new(true,22,false,true,true,true,false)	
		@cavern_2_6=Cavern.new(true,23,true,true,true,true,false)
		@cavern_2_7=Cavern.new(true,24,true,true,false,true,false)	

		@cavern_3_0=Cavern.new(true,25,false,false,true,true,false)	
		@cavern_3_1=Cavern.new(true,26,true,false,true,true,false)	
		@cavern_3_2=Cavern.new(true,27,true,false,true,true,false)	
		@cavern_3_3=Cavern.new(true,28,true,true,true,true,false)	
		@cavern_3_4=Cavern.new(true,29,true,false,true,true,false)		
		@cavern_3_5=Cavern.new(true,30,true,true,false,false,false)		
		@cavern_3_6=Cavern.new(true,31,false,true,true,true,false)	
		@cavern_3_7=Cavern.new(true,32,true,true,false,true,true)	

		@cavern_4_0=Cavern.new(true,33,false,true,false,true,false)	
		@cavern_4_1=Cavern.new(true,34,false,true,true,false,false)	
		@cavern_4_2=Cavern.new(true,35,true,true,true,true,false)
		@cavern_4_3=Cavern.new(true,36,true,true,true,true,false)
		@cavern_4_4=Cavern.new(true,37,true,true,false,false,false)	
		@cavern_4_5=Cavern.new(true,38,false,false,true,true,false)	
		@cavern_4_6=Cavern.new(true,39,true,true,true,false,false)	
		@cavern_4_7=Cavern.new(true,40,true,true,false,false,false) 
		
		@cavern_5_0=Cavern.new(true,41,false,true,true,false,false)
		@cavern_5_1=Cavern.new(true,42,true,false,true,false,false)
		@cavern_5_2=Cavern.new(true,43,true,true,true,false,false)
		@cavern_5_3=Cavern.new(true,44,true,true,true,false,false)
		@cavern_5_4=Cavern.new(true,45,true,false,true,false,false)
		@cavern_5_5=Cavern.new(true,46,true,true,false,false,false)
		@cavern_5_6=Cavern.new(false,47,false,false,false,false,false)
		@cavern_5_7=Cavern.new(false,48,false,false,false,false,false)
	...
	def thePlayerFallInAPit
		if (@caverns[@player.getPos_x][@player.getPos_y].getHasAPit == true)
			return true
		else
			return false
		end
	...
	def isAPitNear
		if(self.hasAccessToNorth==true)
			if (@caverns[@player.getPos_x-1][@player.getPos_y].getHasAPit == true)
				return true
			end	
		end
		...
		if(self.hasAccessToWest==true)
			if (@caverns[@player.getPos_x][@player.getPos_y-1].getHasAPit == true)
				return true
			end	
		end
	...
	def reportAPitNear
		if(self.isAPitNear==true) 
			return "¡Fuerte viento!,¡Un pozo está cerca!"  
		else
			return " "
		end 
	end
